...
export default function MyLearning() {
    ...
    const hover = {
        onMouseEnter: (e) => { e.currentTarget.style.transform = 'translateY(-6px) scale(1.01)'; e.currentTarget.style.boxShadow = '0 16px 36px rgba(0,0,0,0.1)'; },
        ...
        <div style={{ minHeight: '100vh', backgroundColor: '#f8f9fa', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ backgroundColor: '#1c1d1f', padding: '32px 0' }}>
                <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 48px' }}>
                    <h1 style={{ fontSize: '32px', fontWeight: 700, color: '#fff', margin: 0, letterSpacing: '-0.5px' }}>
                        My learning
                    </h1>
                </div>
            </div>
                    ...
                    {filters.map(f => (
                        <button
                            ...
                            style={{
                                ...
                                border: 'none',
                                borderBottom: filter === f.key ? '3px solid #a435f0' : '3px solid transparent',
                                fontSize: '14px', fontWeight: filter === f.key ? 700 : 400,
                                cursor: 'pointer', transition: 'all 0.2s ease',
                            }}
                            onMouseEnter={e => { if (filter !== f.key) e.currentTarget.style.color = '#fff'; }}
                            onMouseLeave={e => { if (filter !== f.key) e.currentTarget.style.color = '#9ca3af'; }}
                        >
                            {f.label} ({f.count})
                        </button>
                    ))}
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                            <svg width="100" height="100" viewBox="0 0 100 100">
                                ...
                                <circle cx="50" cy="50" r="44" fill="none" stroke="#d1d5db" strokeWidth="8"
                                    strokeDasharray="0 276.5" strokeLinecap="round" transform="rotate(-90 50 50)" />
                                ...
                                <circle cx="50" cy="50" r="32" fill="none" stroke="#10b981" strokeWidth="8"
                                    strokeDasharray={`${0.5 * 201} ${201}`} strokeLinecap="round" transform="rotate(-90 50 50)" />
                            </svg>
                        ...
                        <div style={{ flex: 1 }}>
                            ...
                            <div style={{ display: 'flex', gap: '12px' }}>
                                <button style={{
                                    ...
                                    onMouseEnter={e => { e.currentTarget.style.backgroundColor = '#a435f0'; e.currentTarget.style.color = '#fff'; }}
                                    onMouseLeave={e => { e.currentTarget.style.backgroundColor = '#fff'; e.currentTarget.style.color = '#a435f0'; }}
                                >Get Started</button>
                                <button style={{
